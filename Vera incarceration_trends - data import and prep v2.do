***************************************************************
*import and clean up Vera incarceration data
*RD 5/16/19
*updated 3/26/20
*updated 11/17/20 to use macros for filenames
*Rachael converted syntax from SPSS to Stata on 3/4/21
*updated 3/10/21 to use loops to calculate state rates - RD
***************************************************************
...
cd "C:\Users\rdruckhammer\Dropbox (CSG)\AustinOnly\National Reports Data"
...
*save formatted file w/ all years of data
save "$fmt/jail only 1970-2018.dta", replace

*select just the current year of data and export to excel
drop if year<$curr_yr
tab year
export excel using "$fmt/Jail - County Totals 2018.xlsx", firstrow(varlabels) replace
...
*save formatted file w/ all years of data
save "$fmt/prison only 1970-2018.dta", replace

*select just the current year of data and export to excel
drop if year<$curr_yr
tab year
export excel using "$fmt/Prison - County Totals 2018.xlsx", firstrow(varlabels) replace
